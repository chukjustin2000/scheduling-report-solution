...
export class RecipientComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.recipientService
      ...
      .subscribe(
        (res: HttpResponse<IRecipient[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IRecipient): string {
  ...
  protected onSuccess(data: IRecipient[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
